...
class IMU(Sensor):
    ...
    DEV_ADDR = 0x28  # if this doesnt work then try 0x29
    default_mode_set = 5
    ...
    def get_data(self) -> float:
        # This method would be called by closed loop control if the IMU was
        # the sensor in the closed loop. Update the output of this function
        # to return the correct data the closed loop needs.
        return 0.0
