...
if __name__ == "__main__":
    ...
    path_director_obj = PathDirector(Linesensor)
    ...
    task_User_Input = cotask.Task(
        ...
        profile=True,
        trace=False,
        shares=(l_flag_s, r_flag_s, l_speed_s, r_speed_s, data_transfer_s, test_complete_s, cal_white_s, cal_black_s, set_seg_s),
    )
    task_Path_Director = cotask.Task(
        ...
        profile=True,
        trace=False,
        shares=(l_flag_s, l_speed_s, r_flag_s, r_speed_s, data_transfer_s, test_complete_s, cal_white_s, cal_black_s, set_seg_s, seg_start_s),
    )
