...
\item 
\mbox{\hyperlink{class_battery_1_1_battery_a6f7235b1db18423f9e6b3d891dd1da15}{\+\_\+\+\_\+init\+\_\+\+\_\+}} (self, ADC\texorpdfstring{$\vert$}{|}None battery\+\_\+\+ADC=None)
...
\begin{DoxyCompactItemize}
\item 
\Hypertarget{class_battery_1_1_battery_a32e14b12122e17fb0a227c015590614e}\label{class_battery_1_1_battery_a32e14b12122e17fb0a227c015590614e} 
int {\bfseries ADC\+\_\+nom} = 3210
...
\Hypertarget{class_battery_1_1_battery_a9bf4f4b1e49e3b893eed68bf653a8dd3}\label{class_battery_1_1_battery_a9bf4f4b1e49e3b893eed68bf653a8dd3} 
float {\bfseries V\+\_\+nom} = 8.\+5
...
Definition at line \mbox{\hyperlink{_battery_8py_source_l00030}{30}} of file \mbox{\hyperlink{_battery_8py_source}{Battery.\+py}}.


\begin{DoxyCode}{0}
\DoxyCodeLine{00030\ \ \ \ \ \textcolor{keyword}{def\ }\_\_init\_\_(self,\ battery\_ADC:\ ADC\ |\ \textcolor{keywordtype}{None}\ =\ \textcolor{keywordtype}{None}):}
\DoxyCodeLine{00031\ \ \ \ \ \ \ \ \ self.battery\_ADC\ =\ battery\_ADC}
\DoxyCodeLine{00032\ }
\DoxyCodeLine{00033\ \ \ \ \ \ \ \ \ }
\DoxyCodeLine{00034\ \ \ \ \ \ \ \ \ self.ADC\_nom\ =\ 3210}
\DoxyCodeLine{00035\ }
\DoxyCodeLine{00036\ \ \ \ \ \ \ \ \ }
\DoxyCodeLine{00037\ \ \ \ \ \ \ \ \ self.V\_nom\ =\ 8.5}
\DoxyCodeLine{00038\ }

\end{DoxyCode}


References \mbox{\hyperlink{_battery_8py_source_l00031}{battery\+\_\+\+ADC}}.
...
Reads the ADC and returns the ratio of the current reading to the nominal calibrated value. The returned number is a decimal between approximately 0 and 1. Raises {\ttfamily Value\+Error} if no ADC is configured.

\begin{DoxyReturn}{Returns}
A float representing battery charge percentage (0..1). 
\end{DoxyReturn}


Definition at line \mbox{\hyperlink{_battery_8py_source_l00046}{46}} of file \mbox{\hyperlink{_battery_8py_source}{Battery.\+py}}.


\begin{DoxyCode}{0}
\DoxyCodeLine{00046\ \ \ \ \ \textcolor{keyword}{def\ }get\_cur\_perc(self):}
\DoxyCodeLine{00047\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ self.battery\_ADC\ \textcolor{keywordflow}{is}\ \textcolor{keywordtype}{None}:}
\DoxyCodeLine{00048\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{raise}\ ValueError(\textcolor{stringliteral}{"{}Battery\ ADC\ is\ not\ set"{}})}
\DoxyCodeLine{00049\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ self.battery\_ADC.read()\ /\ self.ADC\_nom}
\DoxyCodeLine{00050\ }

\end{DoxyCode}


References \mbox{\hyperlink{_battery_8py_source_l00034}{ADC\+\_\+nom}}, and \mbox{\hyperlink{_battery_8py_source_l00031}{battery\+\_\+\+ADC}}.
...
Definition at line \mbox{\hyperlink{_battery_8py_source_l00057}{57}} of file \mbox{\hyperlink{_battery_8py_source}{Battery.\+py}}.


\begin{DoxyCode}{0}
\DoxyCodeLine{00057\ \ \ \ \ \textcolor{keyword}{def\ }get\_cur\_volt(self):}
\DoxyCodeLine{00058\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ self.battery\_ADC\ \textcolor{keywordflow}{is}\ \textcolor{keywordtype}{None}:}
\DoxyCodeLine{00059\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{raise}\ ValueError(\textcolor{stringliteral}{"{}Battery\ ADC\ is\ not\ set"{}})}
\DoxyCodeLine{00060\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ self.get\_cur\_perc()\ *\ self.V\_nom}

\end{DoxyCode}


References \mbox{\hyperlink{_battery_8py_source_l00031}{battery\+\_\+\+ADC}}, \mbox{\hyperlink{_battery_8py_source_l00046}{get\+\_\+cur\+\_\+perc()}}, and \mbox{\hyperlink{_battery_8py_source_l00037}{V\+\_\+nom}}.
