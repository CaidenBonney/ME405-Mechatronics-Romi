...
def main():
    ...
    file_name = Path(__file__).resolve().parent / "dist500 spd200.csv"
    pairs = [
        ((None, "v_hat"), ("i", "v_hat"), ("-", "mm/s"), False),
        ((None, "v"), ("i", "v"), ("-", "mm/s"), False),
        ((None, "v_avg"), ("i", "v_avg"), ("-", "mm/s"), False),
    ]
    plot_pairs(file_name, svg_folder, pairs, "dist500 spd200")
